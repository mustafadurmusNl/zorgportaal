...
const ADHDTypes = () => {
  const t = useTranslations("adhd.sections.types");
  ...
  const types = [
    {
      key: "inattentive",
      title: t("inattentive.title"),
      description: t("inattentive.description"),
      icon: "🧠",
    },
    {
      key: "hyperactive",
      title: t("hyperactive.title"),
      description: t("hyperactive.description"),
      icon: "⚡",
    },
    {
      key: "combined",
