// src/components/clienten/shared/ClientSidebar.tsx
"use client";
...
const CLIENT_PAGES = [
  {
    id: "voor-wie",
    href: "/clienten/voor-wie",
    icon: "👥",
    translationKey: "voor_wie",
  },
  {
    id: "intake-behandelplan",
    href: "/clienten/intake-behandelplan",
    icon: "📋",
    translationKey: "intake_behandelplan",
  },
  {
    id: "wachttijden",
    href: "/clienten/wachttijden",
    icon: "⏱️",
    translationKey: "wachttijden",
  },
  {
    id: "vergoeding",
    href: "/clienten/vergoeding",
    icon: "💰",
    translationKey: "vergoeding",
  },
];
...
export function ClientSidebar() {
  ...
  // Check if we're on wachttijden page for special CTA
  const isWachttijdenPage = pathname.includes("/clienten/wachttijden");
  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        {/* Special CTA for Wachttijden page */}
        {!isCollapsed && isWachttijdenPage && (
          <div className="mt-6">
            <RegistrationCTA />
          </div>
        )}

        {/* Help section - only when expanded and NOT on wachttijden */}
        {!isCollapsed && !isWachttijdenPage && (
          <div className="mt-8 pt-6 border-t border-gray-100">
            <div className="bg-gradient-to-r from-pink-50 to-purple-50 p-4 rounded-lg">
              ...
              <p className="text-xs text-gray-600 mb-3">
                Heb je vragen over onze diensten? We helpen je graag verder.
              </p>
              <Link
                href={`/${locale}/contact`}
