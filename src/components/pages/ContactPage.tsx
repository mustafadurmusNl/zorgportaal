        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-700">
              ...
              <span className="font-semibold">{t("appointment.hours_required")}</span>{" "}
              {t("appointment.description_2")}{" "}
              <span className="font-semibold text-pink-500">{t("office_hours.phone")}</span>{" "}
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-sm text-red-700 mt-1">
                    ...
                    <span className="font-semibold">{t("appointment.warning.link")}</span>{" "}
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="bg-pink-500 rounded-2xl p-6 text-white">
            ...
            <div className="space-y-3 text-sm">
              ...
              <p>
                {t("sidebar.contact_info.lunch_break")}
              </p>
              <p>
                {t("sidebar.contact_info.emergency")}
              </p>
            </div>
