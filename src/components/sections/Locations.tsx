      ...
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {locations.map((location) => (
            <div key={location.id} className="service-card text-center">
              ...
              <h3 className="service-card-title">{location.name}</h3>
              <p className="service-card-description">{location.address}</p>
