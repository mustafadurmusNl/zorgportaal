...
export const zorgCategories: ZorgCategory[] = [
  ...
  { id: "depressie", href: "/zorgaanbod/depressie", icon: "💙", footerKey: "depression" },
  { id: "trauma", href: "/zorgaanbod/trauma", icon: "🛡️", footerKey: "trauma" },
  // Extended care categories to match the sidebar
  { id: "somatiek", href: "/zorgaanbod/somatiek", icon: "🔗", footerKey: "psychosomatic" },
  { id: "zelfbeeld", href: "/zorgaanbod/zelfbeeld", icon: "🪞", footerKey: "self_image" },
  { id: "persoonlijkheid", href: "/zorgaanbod/persoonlijkheid", icon: "🎭", footerKey: "personality" },
];
